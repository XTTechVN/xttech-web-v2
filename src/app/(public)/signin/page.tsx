...
const Signin = () => {
  return (
    <div className="w-full h-full md:h-auto md:w-[95%] md:max-w-300 bg-white md:border md:border-gray-100 md:rounded-4xl md:shadow-2xl md:shadow-gray-200/40 p-6 md:p-10 overflow-y-auto md:overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        {/* Cột trái: Đăng nhập */}
        <div className="col-span-12 lg:col-span-5 flex flex-col gap-6 lg:border-r lg:border-gray-100 lg:pr-10">
          <LoginIntro/>
          <LoginForm />
          <LoginOption />
        </div>
