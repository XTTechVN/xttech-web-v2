...
export const ShiftStatCard: React.FC<StatCardProps> = ({
  title,
  value,
  icon,
  trend,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 md:gap-3">
        <span className="text-gray-500 text-[10px] md:text-xs font-medium truncate whitespace-nowrap overflow-hidden">
          {title}
        </span>
